package com.demo.cardsservice.resource;
...
import com.demo.cardsservice.model.ErrorResponse;
import com.demo.cardsservice.model.Response;
...
@Tag(name = "CRUD REST APIs for Card", description = "CRUD REST APIs to CREATE, UPDATE, FETCH AND DELETE card details")
